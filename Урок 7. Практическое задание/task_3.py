...
class Cell:
    ...
    def __add__(self, other):
        return f'Результат {self.quantity + other.quantity}'
    ...
    def __truediv__(self, other):
        return f'Результат {int(self.quantity / other.quantity)}'

    def make_order(self, cells_count):
        cell_order = ''
        for i in range(int(self.quantity / cells_count)):
            cell_order += f'{"*" * cells_count}\\n '
        cell_order += f'{"*" * (self.quantity % cells_count)}'
        return cell_order
