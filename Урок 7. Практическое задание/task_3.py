...
class Cell:
    ...
    def __add__(self, other):
        return f'sum of cells is - {self.quantity + other.quantity}'

    def __sub__(self, other):
        if self.quantity > other.quantity:
            return f'subtraction of cells is - {self.quantity - other.quantity}'
        else:
            return f'error, try with other numbers'

    def __mul__(self, other):
        return f'multiplication of cells is - {self.quantity * other.quantity}'

    def __truediv__(self, other):
        return f'division of cells is - {self.quantity // other.quantity}'
