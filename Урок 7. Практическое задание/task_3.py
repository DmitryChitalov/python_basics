...
class Cell():
    ...
    def __add__(self, other):
        с = Cell(self.quantity + other.quantity)
        return с

    def __sub__(self, other):
        x = Cell(0)
        if self.quantity >= other.quantity:
            x.quantity = self.quantity - other.quantity
        else:
            print("Ошибка вычитания, результат меньше нуля! Присваиваем нуль.")
        return x
