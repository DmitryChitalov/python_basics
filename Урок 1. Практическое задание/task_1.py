...
'''
Ещё один вариант решения без переменных, но код становится менее читабельным. 
print('Ваши данные для входа в аккаунт: имя - ', input("Ведите ваше имя:"), ', пароль - ', input("Ведите ваш пароль:"), ', возраст - ', input("Введите ваш возраст:"), sep = '')
'''
