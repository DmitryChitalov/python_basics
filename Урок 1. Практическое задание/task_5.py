...
if prof > 0:
    print(f"Финансовый результат - прибыль. Её велечина: {prof}")
    print("Значит вычисляем рентабельность выручки (соотношение прибыли к выручке)")
    ren = prof / res
    print(f"Рентабельность выручки")

    emp_num = int(input("Введите численность сотрудников фирмы: "))
    emp_pr = prof / emp_num
    print(f"Прибыль фирмы в расчете на одого сотрудника = {emp_pr}")

elif prof < 0:
    print(f"Финансовый результат - убыток. Её величена: {prof}")
