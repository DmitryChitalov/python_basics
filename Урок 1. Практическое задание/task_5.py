...
c = a - b  # Разница
d = a - b  # Прибыль
e = d / a  # Рентабельность

if a > b:
    print("Прибыль составила  " + str(c))
elif a < b:
    print("Убыток составил  " + str(c))
# Убыток или выручка


if a > b:
    print("Рентабельность выручки  " + str(e))
# Показать рентабельность


if a > b:
    f = int(input("Введите численность сотрудников фирмы  "))
    s = d / f
    print("Прибыль фирмы в расчете на одного сотрудника  " + str(s))
