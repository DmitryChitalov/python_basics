...
if revenue > cost:
    ...
    employee_count = int(input("ведите численность сотрудников фирмы: "))
    print(f"Прибыль фирмы в расчете на одного сотрудника = {round((revenue - cost) / employee_count,2)}")

else:
    print(f"Финансовый результат - убыток. Ее величина: {cost - revenue}")
