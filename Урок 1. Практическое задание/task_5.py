...
dirt = int(input("Введите издержки фирмы: "))
res = cash-dirt
if res > 0:
    people = int(input("Введите численность сотрудников фирмы: "))
    everyone = res//people
    print("Прибыль фирмы в расчете на одного сотрудника = " + str(everyone))
elif res == 0:
    print("Вы отработали в ноль")
elif res < 0:
    people = int(input("Введите численность сотрудников фирмы: "))
    everyone = res // people
    print("Убыток фирмы в расчете на одного сотрудника = " + str(everyone))
