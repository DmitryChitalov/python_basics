...
if debit > credit:
    ...
    print(f'Прибыль фирмы в расчете на одного сотрудника = {float((debit - credit) / stuff)}')
elif debit < credit:
    print('Финансовый результат - убыток. Работайте лучше!')
else:
    print('Ничего не заработали. Но и не потеряли!')