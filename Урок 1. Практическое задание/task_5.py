...
if a <= b:
    ...
    st = int(input("Введите численность сотрудников:"))
    f = c / st
print(f"Финансовый результат - прибыль. Ее величина = {c}")
print(f"Рентабельность = {d}"),print(f"Прибыль фирмы в расчете на одного сотрудника = {f}")
