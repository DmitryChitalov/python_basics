...
if fin_res > 0:
    ...
    rent = round(fin_res / v, 2)
    print(f"Рентабельность выручки = {rent}")
    humans = int(input("Введите численность сотрудников фирмы: "))

    print(f"Прибыль фирмы в расчете на одного сотрудника = {fin_res / humans}")
else:
    if fin_res == 0:
        print(f"Выручки нет, убытков тоже. Работа в 0")
    else:
        print(f"Финансовый результат - убыток. Ее величина: {fin_res}")
