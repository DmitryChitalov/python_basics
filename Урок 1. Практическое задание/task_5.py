...
if proceed>costs:
    print('Финансовый результат - прибыль. Ее величина: ', proceed - costs)
    print('Рентабельность: ', (proceed-costs)/proceed)
    staff = int(input('Введите кол-во сотрудников: '))
    print ('Прибыль на одного сотрудника: ', (proceed - costs)/staff)
else:
