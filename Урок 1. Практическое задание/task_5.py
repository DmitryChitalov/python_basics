...
if proceeds > costs:
    print("Финансовый результат - прибыль. Ее величина:", (proceeds - costs))
    print("Рентабельность выручки = ", ((proceeds - costs) / proceeds) * 100, "%")
    staff = int(input("Введите численность сотрудников фирмы:"))
    print("Прибыль фирмы в расчете на одного сотрудника =", (proceeds - costs) / staff)
else:
