...
if a > b:
    c = a-b
    d = c/a
    print(f'Финансовый рузультат - прибыль. Ее величина {a-b} ')
    print(f'Рентабельность выручки = {d}')
    e = int(input('Введите численность сотрудников фирмы: '))
    print(f'Прибыль фирмы в расчете на одного сотрудника {c/e} ')
elif a == b:
    print('Финанстовый результат - в ноль.')
else:
    print('Финансовый результат - потери.')
