...
if revenue > expense:
    print(f'Финансовый результат - прибыль. Ее величина: {revenue - expense}')
    print(f'Рентабельность выручки = : {expense / revenue}')
    employees = int(input('Введите численность сотрудников фирмы: : '))
    print(f'Прибыль фирмы в расчете на одного сотрудника = : {(revenue - expense) / employees}')
else:
    print(f'Финансовый результат - убыток. Ее величина: {expense - revenue}')
