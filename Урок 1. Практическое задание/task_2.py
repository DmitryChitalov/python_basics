...
if hours > 24:
    print('Количество полученных часов превышает количество часов в суткаx,'
          ' скоректируйте ввод.')
else:
    print(f'Количество секунд в формате чч:мм:сс равно:'
          f' {hours_res}:{minutes_res}:{seconds_res}')
