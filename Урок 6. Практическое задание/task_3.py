...
class Position(Worker):  # создаём новый класс на основе Worker
    def __str__(self):  # изменим метод __str__ для нашего класса
...
manager = Position('Иван', 'Петров', 'Менеджер', 50000, 20000)  # создаём экземпляр объекта
senior_manager = Position('Михаил', 'Белов', 'Старший Менеджер', 70000, 25000)  # создаём экземпляр объекта
