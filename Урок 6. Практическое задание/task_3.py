...
реализовать публичные методыполучения полного имени сотрудника (get_full_name)
...
people = Position('Иван', 'Филатов', 'Сварщик', 25000, 53000)
print(people.get_full_name(), people.get_total_income())
print(people)
