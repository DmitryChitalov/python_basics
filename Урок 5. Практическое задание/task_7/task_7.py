...
with open("companies_list.txt", "r", encoding="utf-8") as s_obj:
    companies_profit = {}
    average_profit = {}
    all_profit = 0
    profit_count = 0
...
with open('companies_list.json', "w+", encoding="utf-8") as d_obj:
    json.dump([companies_profit, average_profit], d_obj)
    d_obj.seek(0)
    print(d_obj.read())
