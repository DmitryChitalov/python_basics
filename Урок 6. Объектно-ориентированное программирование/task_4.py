...
my_family_car = TownCar(60, 'черный', 'Лада Ларгус', False)
my_family_car.go()
...
my_work_car = WorkCar(60, 'серый', 'Рено Логан', False)
my_work_car.go()
my_work_car.show_speed(40)
my_work_car.stop()
print()

police_car = PoliceCar(0, 'белый', 'УАЗ Патриот', True)
print()
