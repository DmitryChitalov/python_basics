...
class Storage:
    ...
    def to_storage(self, office_equipment, quantity=1):
        ...
        try:  # обработка исключения, когда количество не является целым числом
...
# проверка
print_1 = Printer('HP', "model1", 2000, 12, 2, 'струйный')
scan_1 = Scanner('Epson', "model2", 3000, 15, 1, 1200)
scan_2 = Scanner('Epson', "model3", 4000, 10, 2, 1200)
copier_1 = Copier('Xerox', "xe1", 1000, 28, 3, True)
...
storage1.from_storage(copier_1, 'бухгалтерию')
storage1.from_storage(copier_1, 'бухгалтерию', 3)
storage1.from_storage(scan_2, 'бухгалтерию', 'два')
