...
if __name__ == '__main__':
    printer01 = Printer('Canon 3010', 15000, True, 'N3456367')
    printer02 = Printer('HP LJ 2035', 35000, False, '1164855SFG5')
    scanner01 = Scanner('Epson Perf V19', 7000, '4800x4800', '65482321FF5')
    scanner02 = Scanner('Canon LiDE 300', 9500, '2400x2400', '31313131FFF')
    copier01 = Copier('Canon PIXMA MG2540S', 22990, True, '4800x600', 8, 'FG8#HHHF')
