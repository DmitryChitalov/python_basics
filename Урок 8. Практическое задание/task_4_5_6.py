...
# проверка реализации
print_1 = Printer('HP', "model1", 2500, 17, 2, 'струйный')
scan_1 = Scanner('Epson', "model2", 3000, 10, 1, 1100)
scan_2 = Scanner('Epson', "model3", 5000, 12, 2, 1200)
copier_1 = Copier('Xerox', "xe1", 1200, 25, 3, True)
