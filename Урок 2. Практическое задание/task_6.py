...
number_items = input("Введите количество позиций вносимых в систему: ")
...
#Нужно ограничить ввод только чисел при вводе цены и кол-ва, чтобы небыло ошибок, так как определяю как int
        ...
        options = dict({'Название': name_product, 'Цена': price_product, 'Количество': amount_product,
