...
my_list = (input("Please enter space-separated values:")).split(" ")
...
for i in range(1,number_of_items,2):        # Create a range of indexes to be processed
    ...
    number1 = my_list[index_even]              # Find number in the list by index1
    number2 = my_list[index_odd]               # Find number in the list by index2

    my_list[index_even] = number2              # Assign new value to the odd index
    my_list[index_odd] = number1               # Assign new value to it's neighbour to the left
